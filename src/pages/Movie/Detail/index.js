...
import CastListAPI from '~/components/CastList/CastListAPI';
                    ...
                    <div className="px-8 py-3 w-[60%] ">
                        <Link>
                            <h2 className="text-[36px] font-bold text-white mb-2 drop-shadow-lg hover:text-white/70">
                                {data?.detail?.title || data?.detail?.original_title}
                            </h2>
                        </Link>
                        ...
                        <CastListAPI id={data.detailID}></CastListAPI>
                        <RecommendedAPI id={data.detailID}></RecommendedAPI>
                    </div>
                </div>
            </div>
        </>
