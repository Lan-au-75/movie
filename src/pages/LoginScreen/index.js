            ...
            <div className="absolute  flex w-full px-[16px] py-[96px] justify-center ">
                <div className=" bg-black/75 max-w-[450px] min-h-[600px] w-full h-full ">
                    <div className="max-w-[320px] py-[64px] m-auto">
                        <h1 className="text-[30px] text-white leading-9 font-bold">Sign In</h1>
                        <form className="py-[16px] flex flex-col" onSubmit={handleSubmit}>
                            <input
                                value={email}
                                type="email"
                                placeholder="Email"
                            ...
                            />
                            <Button className="btn h-[48px] py-[24px] bg-red-700 my-6">Sign In</Button>
                            ...
                            <div className="py-8">
                                <span className="text-gray-600">New to TMDB?</span>
                                <Link to={config.routers.signUp} className="text-white ml-2">
                                    Sign Up
                                </Link>
                            </div>
